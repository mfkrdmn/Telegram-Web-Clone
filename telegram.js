...
class Chat{
    constructor(picture,title,lastMessage){
...
class ChatFunction {
   ...
   addChat(contacts){
        ...
        <div class="col-md-1"><span>14.22</span></div>
   ...
   deleteInputInners(){
    ...
    document.getElementById("contactspic").value = ""
}
...
document.getElementById("btn").addEventListener("click", () => {
    ...
    const chat = new Chat(picture,title,lastMessage)
